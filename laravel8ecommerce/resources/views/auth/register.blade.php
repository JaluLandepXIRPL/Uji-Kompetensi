                        ...
                        <div class="wrap-login-item ">
                            <div class="register-form form-item ">
                                ...
                                <form class="form-stl" action="{{ route('register') }}" name="frm-login" method="post" >
                                    ...
                                    <a class="link-function left-position" href="{{ route('login') }}" title="Sudah punya akun?">Sign In</a>
...
<script>
    $('#frm-reg-lname').keypress(function(e){
        ...
        if (s.toUpperCase() === s && s.toLowersCase() !== s && !e.shiftKey){
            alert('Capslock ON please turn OFF');
        }
    });
</script>
